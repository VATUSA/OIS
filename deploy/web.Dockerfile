...
# Full app version (1.0.1-<sha>) for the footer. `.git` is dockerignored, so vite.config takes it
# from this arg (set by CI). Empty locally → vite derives it from the VERSION file + local git.
ARG OIS_VERSION=""
